...
Retorne um objeto no formato:
{
  ...
  "dados": {
    ...
    "sb": null, "enxofre": null, "boro": null, "zinco": null, "cobre": null,
    "manganes": null, "ferro": null, "ctc": null, "saturacao_bases": null,
    "data_analise": null
  },
  "unidades": {
    "materia_organica": "g/dm3", "fosforo": "mg/dm3", "potassio": "mmolc/dm3",
    "calcio": "mmolc/dm3", "magnesio": "mmolc/dm3", "aluminio": "mmolc/dm3",
    "h_al": "mmolc/dm3", "sb": "mmolc/dm3", "enxofre": "mg/dm3",
...
export default function ImportarAgrupado2040({ talhoes, analises2040Existentes, onSalvar2040, onClose }) {
  ...
  const handleSalvar = useCallback(async () => {
    ...
    for (const item of itens) {
      try {
        const classificacao = classificarExtracaoAnaliseSolo(item.dados, '20-40');
