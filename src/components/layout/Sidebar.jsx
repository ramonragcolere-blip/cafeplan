...
import {
  ...
  Menu, X, Leaf, Settings2, Sprout, FlaskConical, ChevronDown, ChevronRight, Wind, CalendarDays, BarChart3, Receipt, Map } from
'lucide-react';
...
{ path: '/mapa-talhoes', label: 'Mapa de Talhões', icon: Map }];
